                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-30">
                                    <select name="position">
                                        ...
                                        <option>Jr. Graphic Designer</option>
                                        <option>Intern Graphic Designer</option>
                                        <option>Visual Designer</option>
                                        <option>Social Media Manager</option>
                                        <option>Account Executive</option>
                                        <option>2D-3D Animator</option>
            ...
            <div class="col-lg-5 offset-lg-1 d-flex flex-column justify-content-center">
                ...
                <div class="accordion bord mt-20">
                    <div class="item mb-15 wow fadeInUp" data-wow-delay=".1s">
                        <div class="title">
                            <h6 class="fz-18 mb-0">Business Analyst</h6>
                            <span class="ico"></span>
                        </div>
                        <div class="accordion-info">
                            <p class="fz-14">1+ Year Experience</p>
                        </div>
                    </div>
                    <div class="item mb-15 wow fadeInUp" data-wow-delay=".1s">
                        <div class="title">
                            <h6 class="fz-18 mb-0">Business Development Executive</h6>
                            <span class="ico"></span>
                        </div>
                        <div class="accordion-info">
                            <p class="fz-14">1+ Year Experience</p>
                    ...
                    <div class="item mb-15 wow fadeInUp" data-wow-delay=".1s">
                        <div class="title">
                            <h6 class="fz-18 mb-0">Digital Marketing Expert</h6>
                            <span class="ico"></span>
                        </div>
                        <div class="accordion-info">
                            <p class="fz-14">1+ Year Experience</p>
                    ...
                    <div class="item mb-15 wow fadeInUp" data-wow-delay=".1s">
                        <div class="title">
                            <h6 class="fz-18 mb-0">Shopify Developer</h6>
                            <span class="ico"></span>
                        </div>
                        <div class="accordion-info">
                            <p class="fz-14">1+ Year Experience</p>
                    ...
                    <div class="item mb-15 wow fadeInUp" data-wow-delay=".1s">
                        <div class="title">
                            <h6 class="fz-18 mb-0">UI/UX Designer</h6>
                            <span class="ico"></span>
                        </div>
                        <div class="accordion-info">
                            <p class="fz-14">1+ Year Experience</p>
