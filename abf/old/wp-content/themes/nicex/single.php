...
$next = get_next_post();
$related_cats_post = nicex_related_posts(); 
...
<main class="ms-main ms-single-post">
	...
	<?php if( class_exists('ACF') ) : ?>
		...
		<div class="ms-single-post--img">
			<?php if ( $format !== 'gallery' && $format !== 'video' ) : ?>
				<?php get_template_part( 'template-parts/excerpt/parts/media', 'thumbnail-single' ); ?>
			<?php endif; ?>
	...
	<article class="ms-sp--article">
		<div class="entry-content">
			<?php while ( have_posts() ) : the_post();
				the_content( sprintf( __( 'Continue reading %s', 'nicex' ), the_title( '<span class="screen-reader-text">', '</span>', false ) ) );
				nicex_link_pages();
			endwhile; ?>
		</div>
	</article>
				...
				<div class="nav-previous">
					<?php if (!empty($prev)) : ?>
						<a href="<?php echo get_permalink($prev->ID); ?>" rel="prev">
							<div class="prev-post">
								<div class="ms-spp">
									<span class="nav-label" aria-hidden="true"><?php esc_html_e('Previous Article', 'nicex'); ?></span>
				...
				<div class="nav-next">
					<?php if (!empty($next)) : ?>
						<a href="<?php echo get_permalink($next->ID); ?>" rel="next">
							<div class="next-post">
								<div class="ms-spn">
									<span class="nav-label" aria-hidden="true"><?php esc_html_e('Next Article', 'nicex'); ?></span>
	...
	<?php if($related_cats_post->have_posts()): ?>
		<section class="ms-related-posts">
			<div class="alignwide">
				<h2 class="ms-rp--title"><?php esc_html_e('Related Posts', 'nicex'); ?></h2>
					...
					<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute (); ?>">
						<?php if( has_post_thumbnail() ):?>
							<div class="ms-rp--thumb">
								<figure class="card__img media-wrapper">
									<?php the_post_thumbnail('nicex-card-post-thumb', array( 'alt' => get_the_title())); ?>
								</figure>
							</div>
						<?php endif; ?>
