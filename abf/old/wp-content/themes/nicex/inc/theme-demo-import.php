...
// Demo import Files
function nicex_demo_import_files() {
	return array(
	  	array(
		  	'import_file_name'           => 'Nicex Demo Import',
		  	'import_file_url'            => 'https://theme.madsparrow.me/nicex/import/nicex-demo.xml',
		  	'import_widget_file_url'     => 'https://theme.madsparrow.me/nicex/import/widgets.wie',
			'import_customizer_file_url' => 'https://theme.madsparrow.me/nicex/import/customizer.dat',
	  	),
	);
}
add_filter( 'pt-ocdi/import_files', 'nicex_demo_import_files' );

// Disable regenerate thumbnails
add_filter( 'pt-ocdi/regenerate_thumbnails_in_content_import', '__return_false' );

// After setup function
if ( ! function_exists( 'nicex_after_import_setup' ) ) {
	function nicex_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'nicex_after_import_setup' );
