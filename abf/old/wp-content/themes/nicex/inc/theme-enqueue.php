...
class NicexEnqueueAssets{

	public function __construct() {
		$theme_info = wp_get_theme();
		$this->assets_dir = NICEX_THEME_DIRECTORY . 'assets/';
		$this->customizer_frontend_css = NICEX_THEME_DIRECTORY . 'inc/framework/customizer-frontend.css';
		$this->customizer_editor_css = NICEX_THEME_DIRECTORY . 'inc/framework/customizer-editor.css';
	...
	public function enqueue_gutenberg_editor_styles() {
		wp_enqueue_style( 'nicex-gutenberg', $this->assets_dir .'css/nicex-gutenberg-style.css', array(), $this->theme_version );
	}
	...
	public function fonts_url() {
		...
		$fonts = [];
		$display = 'swap';
		$fonts[] = 'Assistant:wght@200;300;400;500;600;700;800';
		$fonts[] = 'Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800';
	...
	public function enqueue_styles() {
		...
		if ( ! class_exists( 'Kirki' ) ) {
			wp_enqueue_style( 'nicex-google-fonts-frontend', $this->fonts_url(), [], null );
			wp_enqueue_style( 'nicex-customizer-editor', $this->customizer_frontend_css, [], $this->theme_version );
		}
		...
		wp_enqueue_style( 'nicex-main-style', $this->assets_dir .'css/main.css', array(), $this->theme_version );
	}
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'nicex-main-script', $this->assets_dir .'js/app.min.js', [ 'jquery' ], $this->theme_version, true );		
	}
	
}

new NicexEnqueueAssets;