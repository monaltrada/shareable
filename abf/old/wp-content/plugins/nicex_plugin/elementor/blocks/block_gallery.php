...
class Widget_MS_Gallery extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'img_background', [
                'label' => __( 'Image Background Color', 'madsparrow' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .mfp-img' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .mfp-img::after, .jg-entry::after' => 'box-shadow: 0px 0px 0px 2pt {{VALUE}} inset',
                ],
            ]
        );
        ...
        $this->add_control(
            'border_radius', [
                ...
                'size_units' => [ 'px', '%', 'em', 'pt' ],
                'selectors' => [
                    '{{WRAPPER}} .blockgallery .mfp-img img, .blockgallery .mfp-none::after, .blockgallery .mfp-none img,.blockgallery.h_s3 .jg-entry::after, .blockgallery.h_s3 .mfp-img::after' => 'border-top-left-radius: {{TOP}}{{UNIT}} {{TOP}}{{UNIT}}; border-top-right-radius: {{RIGHT}}{{UNIT}} {{RIGHT}}{{UNIT}}; border-bottom-right-radius: {{BOTTOM}}{{UNIT}} {{BOTTOM}}{{UNIT}}; border-bottom-left-radius: {{LEFT}}{{UNIT}} {{LEFT}}{{UNIT}};', 
                ],
            ]
        );
