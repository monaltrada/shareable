...
<section class="pg-about section-padding sub-bg">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="bg-img radius-10" data-background="{{ asset('frontend/assets/imgs/about/sq2.jpg') }}"></div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-8">
                <div class="cont mt-80">
                    <h4>If you're looking for a save-the-world company, we're not it. Did you see the new Batman movie? That wasn't us. We are the people bringing these stories to you. We are on a mission to make the world.</h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-around">
            <div class="col-lg-5 valign md-mb50">
                <div class="imgs mb-80">
                    <div class="img1">
                        <img src="{{ asset('frontend/assets/imgs/about/sq1.jpg') }}" alt="" class="radius-10">
                    </div>
                    <div class="img2">
                        <img src="{{ asset('frontend/assets/imgs/about/sq2.jpg') }}" alt="" class="radius-10">
                    </div>
                </div>
            </div>
            <div class="col-lg-5 valign">
                    ...
                    <div class="text">
                        <h2 class="d-slideup wow">
                            <span class="sideup-text">
                                <span class="up-text">Our Vision</span>
                            </span>
                        </h2>
                        <p>We help our clients succeed by creating brand identities, digital experiences, and print materials that communicate clearly, achieve marketing goals, and look fantastic.</p>
                    </div>
