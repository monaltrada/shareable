                    ...
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                ...
                                <a href="JavaScript:void(0)">Career Inquiry</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="table-actions text-center">
                                                ...
                                                <a title="delete this" href="{{ route('career-delete', $row->id) }}">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="lead"><b>Phone Number : </b> {{ $row->phone }}</p><hr>

                    <p class="lead"><b>Position : </b> {{ $row->posname }}</p><hr>

                    <p class="lead"><b>Reference : </b> {{ $row->reference_web_url }}</p><hr>

                    <p class="lead"><b>Experience : </b> {{ $row->experience }}</p><hr>

                    <p class="lead"><b>Current CTC : </b> {{ $row->ctc }}</p><hr>

                    <p class="lead"><b>Expected Salary : </b> {{ $row->salary }}</p><hr>

                    <p class="lead">
                        <b>Document : </b>
                        
                        @if ($row->file)
                        <a href="{{ ($row->file) ? asset('uploads/career/' . $row->file) : '' }}" download>
                            <span class="btn btn-secondary">Click to download Document</span>
                        </a>
                        <a href="{{ ($row->file) ? asset('uploads/career/' . $row->file) : '' }}" target="_blank" class="mx-2">
                            <span class="btn btn-secondary">Click to Open</span>
                        </a>
                        @endif
