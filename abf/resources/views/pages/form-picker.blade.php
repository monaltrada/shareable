    ...
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-xl-4 mb-30">
                                ...
                                <input id="year-range" class="form-control" type="text"
                                    placeholder="Select your date" />
                            </div>
                            <div class="col-sm-12 col-xl-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3>{{ __('Inline Datetimepicker') }}</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-200">
                    <div class="card-header">
                        <h3>{{ __('Dropdown Timepicker') }}</h3>
                    </div>
                    <div class="card-body">
                        <form action="">
                            <div class="form-group">
                                <label for="time">{{ __('Time') }}</label>
                                <input type="text" class="form-control datetimepicker-input" id="timepicker"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" id="rgba" class="form-control demo"
                                                data-format="rgb" data-opacity=".5" value="rgba(52, 64, 158, 0.5)">
                                        </div>
                                    </div>
                                </div>
                            </div>
